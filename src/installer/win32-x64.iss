; -- BracketBrowser-Setup-x64.iss --
;
; This script installs BracketBrowser (x64).
...
OutputDir=./
OutputBaseFilename=BracketBrowser-win32-x64-Installer
...
Source: "../../dist/BracketBrowser-win32-x64\*"; DestDir: "{app}"; Flags: recursesubdirs;
; Include the splash:
...
begin
  ...
  if CompareText(SystemArchitecture, 'x64') = 1 then
  begin
    MsgBox('This installer (x64) is not compatible with your system architecture. Your system is ' + SystemArchitectureFull + '.', mbError, MB_OK);
    WizardForm.Close;
    Abort;
  end;
