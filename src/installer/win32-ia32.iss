; -- BracketBrowser-Setup-ia32.iss --
;
; This script installs BracketBrowser (ia32).
...
OutputDir=./
OutputBaseFilename=BracketBrowser-win32-ia32-Installer
...
[Files]
; Include ../../dist/BracketBrowser-win32-ia32:
Source: "../../dist/BracketBrowser-win32-ia32\*"; DestDir: "{app}"; Flags: recursesubdirs;
; Include the splash:
...
begin
  ...
  begin
    ...
    begin
      SystemArchitectureFull := '64-bit (ia32)';
  ...
  if CompareText(SystemArchitecture, 'ia32') = 1 then
  begin
    MsgBox('This installer (ia32) is not compatible with your system architecture. Your system is ' + SystemArchitectureFull + '.', mbError, MB_OK);
    WizardForm.Close;
    Abort;
  end;
